    ...
    return (
        <div className="min-h-screen bg-[#111115] text-gray-100 p-6 flex flex-col items-center justify-center">
            ...
            <div className="text-center mb-12 max-w-xl">
                <h1 className="text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500 uppercase tracking-wider mb-3">
                    Subscription Tiers
                </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full px-4">
                {tiers.map((tier, index) => (
                    <Card 
                        key={index}
                        className={`bg-[#16161a] border ${
                            tier.isPopular ? 'border-purple-500 shadow-[0_0_20px_rgba(168,85,247,0.2)]' : 'border-gray-800'
                    ...
                    >
                        ...
                        <CardFooter className="p-0">
                            <Button
                                className={`w-full font-bold text-sm tracking-wider uppercase py-5 rounded-xl transition-all ${
                                    tier.name === "Free" 
                                        ? "bg-gray-800 text-gray-400 border border-gray-700 cursor-not-allowed" 
                                        : tier.isPopular 
                                            ? "bg-linear-to-r from-purple-500 to-pink-500 text-white shadow-lg hover:brightness-110" 
