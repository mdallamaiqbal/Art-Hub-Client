...
const ForbiddenPage = () => {
    return (
        <div className="min-h-screen bg-[#111115] text-gray-100 flex flex-col items-center justify-center p-6 relative overflow-hidden">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[500px] md:h-[500px] bg-red-600/10 blur-[120px] rounded-full pointer-events-none"></div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] md:w-[350px] md:h-[350px] bg-purple-500/5 blur-[100px] rounded-full pointer-events-none"></div>
            ...
            <div className="max-w-md w-full text-center relative z-10">
                ...
                <p className="text-sm text-gray-400 mb-8 leading-relaxed px-4">
                    Sorry! You don't have the required role or permission to view this page. If you think this is a mistake, try logging in with an authorized account.
                </p>
